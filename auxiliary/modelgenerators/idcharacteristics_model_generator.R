...
#here, the ID Charateristics model from DSAIDE is  is implemented
#the model as created below has the structure required by the modelbuilder package
#the model is saved as an Rds file
...
var = vector("list",6)
var[[1]]$varname = "S"
var[[1]]$vartext = "Susceptible, uninfected individuals"
var[[1]]$varval = 1000
var[[1]]$flows = c('-bE*S*E','-bI*S*I','+m','-n*S')
var[[1]]$flownames = c('infection by exposed','infection by symptomatic','births','natural deaths')

var[[2]]$varname = "P"
var[[2]]$vartext = "Presymptomatic individuals who are infected and possibly infectious"
var[[2]]$varval = 1
...
var[[3]]$varname = "A"
var[[3]]$vartext = "Asymptomatic individuals who are infected and possibly infectious"
var[[3]]$varval = 1
var[[3]]$flows = c('+gE*E','-gI*I','-n*I')
var[[3]]$flownames = c('progression to symptoms','recovery','natural deaths')

var[[4]]$varname = "I"
var[[4]]$vartext = "Sympomatic infected individuals, most likely infectious"
var[[4]]$varval = 1
var[[4]]$flows = c('+gE*E','-gI*I','-n*I')
var[[4]]$flownames = c('progression to symptoms','recovery','natural deaths')

var[[5]]$varname = "R"
var[[5]]$vartext = "Removed / recovered individuals, no longer infectious or susceptible"
var[[5]]$varval = 0
var[[5]]$flows = c('+gI*I','-w*R','-n*R')
var[[5]]$flownames = c('recovery','waning immunity','natural death')

var[[6]]$varname = "D"
var[[6]]$vartext = "Individuals who have died from the disease"
var[[6]]$varval = 0
var[[6]]$flows = c('+gI*I','-w*R','-n*R')
var[[6]]$flownames = c('recovery','waning immunity','natural death')

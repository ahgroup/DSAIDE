...
currentrmdfile = "basicsir_documentation.Rmd"
...
alltasks = data.frame(quizID=rep("dsaide_app_1",ntasks), AppTitle = appsettings$apptitle, AppID = appsettings$appid, TaskID = 1:ntasks,  TaskText =  rep("",ntasks))
...
# alltasks = data.frame(AppTitle = "Basic", AppID = 1, TaskID = 1:ntasks,  TaskText =  rep("",ntasks))

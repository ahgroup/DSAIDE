...
shiny::tagList(shiny::selectInput("samplepar", "Parameter to vary",c('b' = 'b', "g" = "g", 'm'='m','n'='n')), shiny::selectInput("pardist", "Spacing of parameter values", c('linear' = 'lin', 'logarithmic' = 'log')))

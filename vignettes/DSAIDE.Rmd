...
Compartmental deterministic SIR-type
...
|   Characteristics of ID     | 6 compartment ODE model | Allows exploration of different disease states, e.g. pre-symptomatic, asymptomatic, symptomatic and how they impact ID dynamics in a single outbreak. |  
|   ID Patterns     | 6 compartment ODE model | Includes births-deaths, waning immunity, seasonality. Allows exploration of different ID patterns (single outbreak, osciallations, steady states). |  
|   Direct Transmission   | 3 compartment ODE model | Allows switching between density-dependent and frequency-dependent transmission and exploration of its impact on ID dynamics. Births-deaths and waning immunity are included. |  
|   Environmental Transmission   | 4 compartment ODE model | Includes explicit environmental stage. Allows exploration of the impact of environmental shedding, decay and transmission. Births-deaths and waning immunity are included. |  
|   Vector Transmission   | 5 compartment ODE model | Includes susceptible and infected vectors and their dynamics. Allows exploration of a simple vector-borne transmission model. Births-deaths for vectors and waning immunity for hosts are included. |  

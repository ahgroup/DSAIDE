...
* For this app, the underlying function running the simulation is called `simulate_stochastic_SEIR.R`. Check the help file for the function to see how to call it directly.

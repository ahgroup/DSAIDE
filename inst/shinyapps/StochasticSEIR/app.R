############################################################
#This is the Shiny file for the Stochastic SEIR model App
...
ui <- fluidPage(
  ...
  fluidRow(
    ...
    column(6,
        ...
        fluidRow(
             column(4,
                    numericInput("bE", "Rate of transmission of exposed hosts (bE)", min = 0, max = 0.02, value = 0, step = 0.0001  )
             ),
             column(4,
        ...
        fluidRow(
             column(4,
                    numericInput("gE", "Rate at which exposed hosts leave compartment (gE)", min = 0, max = 5, value = 0.5, step = 0.1)
             ),
             column(4,

...
server <- function(input, output, session) {
  ...
  observeEvent(input$PathogenDynamics, {
    input$PathogenDynamics
    print("Running PathogenDynamics...")
...
ui <- fluidPage(
  ...
  fluidRow(
    ...
    column(4, 
            actionButton("PathogenDynamics", "Pathogen Dynamics", class = "mainbutton")
    ),
    class = "mainmenurow"
  ),
  fluidRow(

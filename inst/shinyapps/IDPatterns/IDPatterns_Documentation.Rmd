...
* Set everyhing as in the beginning of the previous task. Then, let birth rate _m=10_, natural death rate _n=0.005_, and simulation time of 600 months, and record the simulation results and explain what you observe.

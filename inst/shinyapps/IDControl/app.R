...
refresh <- function(input, output){
  ...
  result <- reactive({
    ...
    withProgress(message = 'Running Simulation', value = 0,
      ...
      {
          simresult <- simulate_idcontrol(S0 = S0, I0 = I0, E0 = E0, Sv0 = Sv0, Iv0 = Iv0, tmax = tmax,
                                  bP = bP, bA = bA, bI = bI, bE = bE, bv = bv, bh = bh, gP = gP , gA = gA,
                                 gI = gI, pA = pA, pI = pI, c = c, f = f, d = d, w = w, mh = mh, nh = nh, mv = mv, nv = nv)

...
###Task 1: 
* Run the simulation with a population size (*S0*) of 1000, 1 initially infected host (*I0*) , simulation duration 100 days, recovery rate _g_=0.5 per day, and infectiousness _b_=0.001. You will get an outbreak of some - currently unspecified - infectious disease. 
...
###Task 4: 
* Now, double the number of susceptibles (i.e. *S0*), leave everything else as you just had.

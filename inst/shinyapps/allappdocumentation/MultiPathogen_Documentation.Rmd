...
###Task 3: 
* Now start with _I~1~0=1_ and _I~2~0=10_. What do you expect to see? What do you find?

###Task 4: 
* Go back to _I~1~0=I~2~0=1_, instead set _b~2~=0.002_. What do you expect to see? What do you find?

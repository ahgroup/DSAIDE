...
* Now set initial number of infected with pathogen 1 to 0, with pathogen 2 to 1. Run simulation and check that you get exactly the same size outbreak with pathogen 2.
...
###Task 5:
* Set everyting back as in task #2, i.e. the 2 pathogens have the same starting numbers and transmission rates.

...
* For this app, the underlying function running the simulation is called `simulate_idcontrol.R`. You can call this function directly, without going through the shiny app. Type `?simulate_idcontrol` into the R console for more information (you need to exit the graphical interface first or start a new R session). If you go that route, you need to use the results returned from this function and produce useful output (such as a plot) yourself. 

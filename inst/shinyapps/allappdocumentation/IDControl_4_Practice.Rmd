...
_Some of the simulations might take a few seconds to run. While they run, you should see a 'Simulation running' message in the upper right corner._
...
* Set the model such that only symptomatics transmit, at  rate 0.004 and duration of symptomatic period 1 month. Nobody else transmits. Everying else as in task 2. You should get an outbreak of the same size as in task 1.

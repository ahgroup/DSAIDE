...
* Set the model parameters such that it corresponds to the following setting: 
    * A population size, _S~0~_, of 1000, 1 initially infected host, _I~0~_, no pathogen in environment (_E~0~_ = 0) , simulation duration, _tmax_, approximately 5 years.
    ...
    * Assume that the duration of the infectious period, _g_, is about 2 months long. 

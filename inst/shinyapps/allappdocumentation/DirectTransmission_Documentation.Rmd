...
**The tasks below are described in way that assumes that everything is in units of MONTHS (rate parameters, therefore, have units of inverse days). If any quantity is not given in those units, you need to convert it first (e.g. if it says a week, you need to convert it to 7 days).**

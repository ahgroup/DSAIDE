...
* Recovered individuals are initially immune to reinfection. They can lose their immunity at rate _w_ and return back to the susceptible compartment. 
...
* For this app, the underlying function running the simulation is called `simulate_stochastic.R`. You can call this function directly, without going through the shiny app. Type `?simulate_stochastic` into the R console for more information (you need to exit the graphical interace first or start a new R session). If you go that route, you need to use the results returned from this function and produce useful output (such as a plot) yourself. 

...
* Set the model parameters such that it corresponds to the following setting: 
    * For type 1; susceptible _S1~0~ = 1000_ and infected _I1~0~ = 1_.
    * For type 2; susceptible _S2~0~ = 200_ and infected _I2~0~ = 1_.
...
###Task 3: 
* Keep all settings as before, but set _I1~0~ = 0_. 
* Contemplate what you expect to see, run the simulation, see if your expectations are confirmed.
* Now set _I1~0~ = 1_, and infected type 2 _I2~0~ = 0_. 
* Contemplate what you expect to see, run the simulation, see if your expectations are confirmed.

###Task 4: 
* Set _b~11~ = 0_ and _b~22~ = 0.002_. 
* Set the transmission rate _b~21~ = 0.01_, and _b~12~ = 0.002_. Those are the same values used in task 1 for transmission among the same hosts. 
...
###Task 5: 
* Repeat _Task 5_, with _I1~0~ = 1_, and _I2~0~ = 0_.
* Contemplate what you expect to see, run the simulation, see if your expectations are confirmed.

###Task 6: 
* Repeat _Task 5_, with _I1~0~ = 0_, and _I2~0~ = 1_.
* Contemplate what you expect to see, run the simulation, see if your expectations are confirmed.
...
###Task 8: 
* With the settings you just had, set waning immunity _w~1~ = 0_, run the simulation and see what you get.
* Set waning immunity _w~1~ = 0.2_ and _w~2~ = 0_, run the simulation and see what you get.

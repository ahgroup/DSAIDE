...
![Model Figure](../../media/basicSIRmodelfigure.png)
...
* For this app, the underlying function running the simulation is `simulate_introduction.R`. You can call this function directly, without going through the shiny app. Type `?simulate_introduction` into the R console for more information (you need to exit the graphical interface first or start a new R session). 

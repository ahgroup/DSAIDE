...
ui <- fluidPage(
  ...
  fluidRow(
          column(4,
              sliderInput("bP", "Level/Rate of transmission by presymptomatic hosts (bP, 1/months)", min = 0, max = 0.01, value = 0, step = 0.0001)
              ),
          column(4,
              sliderInput("bA", "Level/Rate of transmission by asymptomatic hosts (bA, 1/months)", min = 0, max = 0.01, value = 0, step = 0.0001)
              ),
          column(4,
                 sliderInput("bI", "Level/Rate of transmission by symptomatic hosts (bI, 1/months)", min = 0, max = 0.01, value = 0, step = 0.0001)
          ),
          align = "center"
          ), #close fluidRow structure for input
  fluidRow(
      column(4,
             sliderInput("gP", "Rate of recovery of presymptomatic hosts (gP, 1/months)", min = 0, max = 2, value = 0.5, step = 0.1)
      ),
      column(4,
             sliderInput("gA", "Rate of recovery of asymptomatic hosts (gA, 1/months)", min = 0, max = 2, value = 0.5, step = 0.1)
      ),
      column(4,
             sliderInput("gI", "Rate of recovery of symptomatic hosts (gI, 1/months)", min = 0, max = 2, value = 0.5, step = 0.1)
      ),
      align = "center"
  ), #close fluidRow structure for input
  fluidRow(

...
#'   result <- simulate_hostheterogeneity_ode()
#'   # To choose parameter values other than the standard one, specify them like such:
#'   result <- simulate_hostheterogeneity_ode(S1 = 100, S2 = 1e3, b11 = 0.7, tmax = 100)
...
simulate_hostheterogeneity_ode <- function(S1 = 1e3, I1 = 1, S2 = 1e3, I2 = 0, b11 = 0.01, b12 = 0, b21 = 0, b22 = 0, g1 = 1, g2 = 1, w1 = 0, w2 = 0, tmax = 120)
{

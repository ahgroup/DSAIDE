...
#' @param sigma strength of seasonal/annual sigmoidal variation of transmission rate
...
simulate_idpatterns <- function(PopSize = 1000, P0 = 1, tmax = 300, bP = 0, bA = 0, bI = 1/1000, gP = 0.5, gA = 0.5, gI = 0.5, f = 0, d = 0, w = 0, lambda = 0, n = 0, sigma = 0)
{
  ...
  pars = c(bP = bP, bA = bA, bI = bI, gP = gP , gA = gA, gI = gI, f = f, d = d, w = w, lambda = lambda, n = n, sigma = sigma);

...
#' @param g : rate at which hosts recover (inverse of symptomatic duration) : numeric
...
simulate_SIRSd_model_ode <- function(S = 1000, I = 1, R = 0, n = 0, b = 0.001, g = 1, w = 1, m = 1, tstart = 0, tfinal = 100, dt = 0.1) 
{ 
  ############################## 
  ...
  #Running the model 
  simout = deSolve::ode(y = varvec_mb, parms = parvec_mb, times = timevec_mb,  func = SIRSd_model_ode_fct) 

...
Next double the values for both natural birth and death rates. What do you get for the value of S at steady state? Is that surprising? If it is, take another look at the relation between $R_0$ and S at steady state, and the equation for $R_0$ (what does it contain, what does it not contain?)"

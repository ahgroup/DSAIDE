...
The main model we are focused on here is a stochastic implementation of the variables and processes described aboe. This model is _not_ an ordinary differential equation model. It is instead its stochastic equivalent.

...
* $b_{ij}$ is the rate of infection to susceptible individuals ($S_i$) from infected individuals ($I_j$). This leads to the susceptible individual leaving the S compartment and entering the I compartment. Transmission among and between groups can occur at different rates.   
...
# Task 5
tid = 5
alltasks[tid,"TaskText"] = "A) * Now lets implement control that targets mainly the elderly group, again keeping the overall efective reproductive number the same. This can be achieved by setting $f_1=0; f_2=0.318; f_3=1$. Keep all other values as previously. Run the simulation. You should see susceptibles at the end of the outbreak at $S_c = 69988$, $S_a = 157328$, $S_e = 155342$ and deaths of $D_c = 130$, $D_a = 3927$, $D_e = 9465$. Overall, you will find that control applied to the elderly is best in terms of mortality, and beats the strategy of strong control for each group, since still enough get infected to prevent a rebound of the outbreak."

...
* If you have worked through the reproductive number app already, contemplate what R~0~ was for both types/populations in task 1, what it is now in task 2, and how that influences what you see in the simulation. 

**Record**

* R~0~ for type 1 hosts
...
* Number of type 1 susceptible remaining at the end
...
* Number of type 1 recoved at the end
* Number of type 2 recoved at the end

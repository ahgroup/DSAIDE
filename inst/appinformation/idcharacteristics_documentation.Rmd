...
# Task 4
tid = 4
alltasks[tid,"TaskText"] = "Next, let's assume that half the symptomatic infected die. Change the corresponding parameter in the model to reflect this new assumption. Leave everything as in task 3. How do you expect the results to change?"

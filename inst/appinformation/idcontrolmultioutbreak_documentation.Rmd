...
nrec = 1 # number of items to record
out_records = c("Percent susceptible at which you stop getting an outbreak (herd immunity level)")
...
out_records = c("Number of susceptible at end of outbreak for f=0.5",

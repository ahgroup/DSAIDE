...
where _f_ is zero outside of the treatment interval given by _tstart_ and _tend_. Furhter, at intervals _tnew_, the number of infected increases by 1.
...
* Run the simulation for 200 days. You should get an outbreak with around 20 susceptibles left at the end.

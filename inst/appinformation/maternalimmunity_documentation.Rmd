...
* Set the rate of revovery, *g*, so that it corresponds to an average recovery period of 25 days.
...
* Set *p* to 0.0041, $b_I$ to 0.17, and *g* to 0.238. Think about what these rates mean about the biology that is occuring here.
* Keep *w* at 0 for now.

...
currentrmdfile = "11_environmentaltransmission_documentation.Rmd" #for debugging 
...
* Number of susceptible/infected/recovered remaining at the end of the outbreak.
* Fraction of susceptible/infected/recovered remaining at the end of the outbreak

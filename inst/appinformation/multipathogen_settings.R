############################################################
#This is a file for the multipathogen App
...
appsettings$appid = 17

#Title of app, to be displayed on top of analyze tab
appsettings$apptitle = "Multi-Pathogen Dynamics"

#name of underlying simulation function(s) to be used in the app
#must be provided
appsettings$simfunction = 'simulate_multipathogen_ode'

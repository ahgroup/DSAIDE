...
allrecord[1,"Record"] = "Mean number of susceptible at end of outbreak"
...
allrecord[2,"Record"] = "Mean peak of infected when transmission is increased by a factor of 10"
...
allrecord[3,"Record"] = "Mean peak of infected when transmission is decreased by a factor of 10"
...
B) Test your assumption by decreasing lower/upper bounds for the birth rate by a factor of 10.
C) Reset the birth rate, now decrease the lower and upper bounds for the death rate by a factor of 10.
D) Reset the birth rate, now increase the lower/upper bounds for both birth and death rate by a factor of 10."

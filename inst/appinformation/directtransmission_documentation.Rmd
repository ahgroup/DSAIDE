...
B) What do you expect to see for the frequency and density dependent scenarios? Does anything change? Do you undstand why?"

# Record for task 3
nrec = 2 # number of items to record
reclist$rectext = c("Total number of recovered at end of outbreak (senario = 1)",
                    "Total number of recovered at end of outbreak (senario = 2)")

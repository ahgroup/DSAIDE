...
source(here::here("inst/appinformation","filltasks.R"))
...
rectext = c("Total number of recovered at end of outbreak")
...
# Task 2
tid = 2
alltasks[tid,"TaskText"] = "A) Switch the plotting to have x-axis, y-axis or both plotted on a log scale. Leave all other settings as before.
...
### Task 4
tid = 4
alltasks[tid,"TaskText"] = "A) Set \"Models to run\" to \"both\", which runs and shows both the continuous-time and discrete-time models. Start with a discrete-time step of 0.01. Leave all other settings as before. Run the simulation, see what you get. You should see the results from the 2 models essentially on top of each other and barely distinguishable."

# Record for task 4
nrec = 2 # number of items to record
rectext = c("Number of susceptible at end of outbreak for continuous-time model",
            "Number of susceptible at end of outbreak for discrete-time model")
recnote = c("Report the rounded integer",
            "Report the rounded integer")
recfuzzy = c(0,0)
allrecord <- filltasks(tid,rc,nrec,rectext,recnote,recfuzzy,allrecord)
...
rectext = c("Number of susceptible at end of outbreak",
            "Number of recovered at end of outbreak",
            "Day the outbreak peaked")
recnote = c("Report the rounded integer",
            "Report the rounded integer",
            "Report the rounded integer")
recfuzzy = c(0,0,1)
...
### Task 7
tid = 7 
alltasks[tid,"TaskText"] = "A) Double the rate of recovery, _g_, leave everything else as previously. How do you expect the results to change? (Try to make your prediction as precise/quantitative as you can.) Run the simulation with these new parameter settings. Compare your expectations with the results. How do they agree/disagree? Does it make sense? Anything surprising happening?"

# Record for task 7
nrec = 3 # number of items to record
rectext = c("Number of susceptible at end of outbreak",
            "Number of recovered at end of outbreak",
            "There is a peak for the outbreak (TRUE/FALSE)")
recnote = c("Report the rounded integer",
            "Report the rounded integer",
...
### Task 8 
tid = 8
alltasks[tid,"TaskText"] = "A) Double the number of susceptibles, _S~0~_, leave everything else as you just had. How do you expect the results to change? Run the simulation with these new parameter settings. Compare your expectations with what results. How do they agree/disagree? Does it make sense? Anything surprising happening?"
...
# Task 9
tid = 9
alltasks[tid,"TaskText"] = "A) Keep playing around with changing any of the parameters and starting conditions. Every time, think about what you expect to get, then run the simulation, compare your expectations with the results. Then make sense of it. What is the minimum and maximum number of outbreaks you can get? Why is that?"

# Record for task 9
nrec = 2 # number of items to record
rectext = c("Minimum number of outbreaks you can get",
            "Maximum number of outbreaks you can get")
recnote = c("Report an integer",
            "Report an integer")
recfuzzy = c(0,0)
allrecord <- filltasks(tid,rc,nrec,rectext,recnote,recfuzzy,allrecord)
rc = rc + nrec
...
# This loop prints all the stored text above
# prints task and items to record

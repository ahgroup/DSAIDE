...
### Task 3 
tid = 3
alltasks[tid,"TaskText"] = "A) From the graph, get a (rough) estimate of the day at which the outbreak peaks. That's easiest done when you make a plotly plot.
...
nrec = 2
rectext = c("Day the outbreak peaked",
            "Total number infected at end of outbreak")
recnote = c("Report the rounded integer",
            "Report the rounded integer")
recfuzzy = c(1,0)
allrecord <- filltasks(tid,rc,nrec,rectext,recnote,recfuzzy,allrecord)
rc = rc + nrec

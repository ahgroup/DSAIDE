...
* Part 2: Also plot (either by hand or using the computer) a graph of _r~I~_ versus _D~f~_ to determine the effect of the extent of surveillance on the total number of deaths that occurred.

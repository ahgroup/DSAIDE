...
* Run simulations. You should pretty much always get outbreaks. 
* Why do you almost always have outbreaks for this setting and fewer outbreaks/more extinctions for task 1?

**Record**

* The average number of susceptibles left at the end.
...
* Draw conclusions about the usefulness of treatment.

**Record**

* The average number of susceptibles left at the end when _f_ = 0
* The average number of susceptibles left at the end when _f_ = 0.25
* The average number of susceptibles left at the end when _f_ = 0.5
* The average number of susceptibles left at the end when _f_ = 0.75
* The average number of susceptibles left at the end when _f_ = 1
...
* The average number of susceptibles left at the end _f_ = 0
* The average number of susceptibles left at the end _f_ = 0.25
* The average number of susceptibles left at the end _f_ = 0.5
* The average number of susceptibles left at the end _f_ = 0.75
* The average number of susceptibles left at the end _f_ = 1

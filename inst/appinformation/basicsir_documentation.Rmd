...
{
  print("Task ",n)
  print(alltasks[n,"TaskText"])
  print(alltasks[n,"Record"])
}
```
...
### Task 3 
A) From the graph, get a (rough) estimate of the day at which the outbreak peaks. That's easiest done when you make a plotly plot.

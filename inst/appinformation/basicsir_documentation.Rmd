...
allrecord = data.frame(TaskID = rep("",nrecord), Record = rep("",nrecord), Note = rep("",nrecord), Answer = rep("",nrecord), Fuzzy = rep(0,nrecord), Review = rep(0,nrecord))
...
write.table(alltasks, "basicsir_alltasks.txt", append = FALSE, sep = "\t", row.names = F, col.names = TRUE)

write.table(allrecord, "basicsir_allrecord.txt", append = FALSE, sep = "\t", row.names = F, col.names = TRUE)

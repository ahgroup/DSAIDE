...
alltasks = data.frame(TaskID = 1:ntasks, TaskText = rep("",ntasks), Record = rep("",ntasks))
...
alltasks[1,"Record"] = "* Total number of recovered at end of outbreak"
...
alltasks[4,"Record"] = "* Number of susceptible at end of outbreak for continuous-time model \n * Number of susceptible at end of outbreak for discrete-time model"
...
alltasks[5,"Record"] = "* Number of susceptible left at end of outbreak for **both** models with _dt = 1_."
...
alltasks[6,"Record"] = "* Number of susceptible at end of outbreak \n * Number of recovered at end of outbreak \n * Time of peak"
...
alltasks[7,"Record"] = "* Number of susceptible at end of outbreak \n * Number of recovered at end of outbreak \n * Time of peak"
...
alltasks[8,"Record"] = "* Number of susceptible at end of outbreak \n * Number of recovered at end of outbreak \n * Time of peak"
...
alltasks[9,"Record"] = "* Minimum number of outbreaks you can get \n * Maximum number of outbreaks you can get"

xlsx::write.xlsx(alltasks, file = "basicsir_alltasks.xlsx")

saveRDS(alltasks, file = "basicsir_alltasks.Rda")

test<-readRDS("basicsir_alltasks.Rda")

test2<-xlsx::read.xlsx("basicsir_alltasks.xlsx",1)
...
for (n in 1:ntasks)
{
  writeLines(c(paste('### Task ',n), '\n', paste(test2[n,"TaskText"]), '\n',  '**Record**', '\n', paste(test2[n,"Record"]), '\n\n'))
}


# for (n in 1:ntasks)
# {
#   writeLines(c(paste('### Task ',n), '\n', paste(alltasks[n,"TaskText"]), '\n',  '**Record**', '\n', paste(alltasks[n,"Record"]), '\n\n'))
# }

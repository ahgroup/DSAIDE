...
tablist<-fill_tasktable(alltasks,allrecord,tid,rc,nrec,reclist,appsettings) #the allrecord table is updated with the new entries
...
reclist$rectext = c("Day the outbreak peaked",
                    "Total number infected at end of simulation (compute as described in text)")
reclist$recnote = c("Report the rounded integer",
...
nrec = 2 # number of items to record
reclist = list()
reclist$rectext = c("Number of susceptible at end of simulation for continuous-time model",
...
nrec = 2 # number of items to record
reclist = list()
reclist$rectext = c("Number of susceptible left at end of simulation for continuous-time model dt=1",
...
### Task 8 
tid = 8
alltasks[tid,"TaskText"] = "A) Half the number of susceptibles, _S~0~_, leave everything else as you just had. How do you expect the results to change? Run the simulation with these new parameter settings. Compare your expectations with the results. How do they agree/disagree? Does it make sense? Anything surprising happening?"

...
alltasks = data.frame(AppTitle = appsettings$apptitle, AppID = appsettings$appid, TaskID = 1:ntasks,  TaskText =  rep("",ntasks))

# used only when running locally to trouble shoot
# = data.frame(AppTitle = "Basic", AppID = 1, TaskID = 1:ntasks,  TaskText =  rep("",ntasks))
...
allrecord[7,"Note"] = "Report the rounded integer"
...
allrecord[8,"Note"] = "Report the rounded integer"
...
write.table(alltext, "1_alltext.tsv", append = FALSE, sep = "\t", row.names = F, col.names = TRUE)

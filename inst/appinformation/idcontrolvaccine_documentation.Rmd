...
#########################
tid = 7
tasktext = "To what percentage of the initial value do we need to reduce transmission to prevent an outbreak? Determine this by reasoning/using _R~0~_, then confirm with the model." 
nrec = 1 # number of items to record
out_records = c("Percentage of the initial value to which transmission needs to be reduced")
out_types = rep("Rounded_integer",nrec)
out_notes = rep("Report rounded integer",nrec)
outcomes = data.frame( TaskID = rep(tid,nrec),
                       TaskText = rep(tasktext,nrec),

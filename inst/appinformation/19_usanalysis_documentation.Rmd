...
allrecord[4,"Record"] = "Mean number of susceptible at end of outbreak (Part B). Use 100 samples and rngseed=100"  
...
allrecord[5,"Record"] = "Mean number of susceptible at end of outbreak (Part C). Use 100 samples and rngseed=100"   
...
allrecord[7,"Record"] = "The correlation between infection peak and **b**. Use 150 samples and rngseed=100"   
...
allrecord[8,"Record"] = "The correlation between final number of susceptibles and **m**. Use 150 samples and rngseed=100"  
...
C) Now increase the 'noise' by also allowing _n_ to vary between 0.1 and 0.5. You will see much 'noisier' plots and the correlation coefficients change. 
...
allrecord[10,"RecordID"] = 1

allrecord[10,"Record"] = "Correlation between _g_ and the outbreak peak (Part C). Use 150 samples and rngseed=100"

allrecord[10,"Note"] = "Report to the hundredths"

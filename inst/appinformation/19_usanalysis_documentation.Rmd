...
rectext = c("Mean number of susceptible at end of outbreak (Part A)")
...
rectext = c("Mean peak of infected when transmission is increased by a factor of 10 (Part B)",
...
nrec = 2 # number of items to record
rectext = c("Mean number of susceptible at end of outbreak (Part B)",
...
nrec = 2 # number of items to record
rectext = c("The correlation between infection peak and _b_ (Part C)",
            "The correlation between final number of susceptibles and _m_ (Part C)")
recnote = c("Report to the hundredths",
            "Report to the hundredths")
recfuzzy = c(0.01,0.01)
allrecord <- filltasks(tid,rc,nrec,rectext,recnote,recfuzzy,allrecord)
rc = rc + nrec
...
nrec = 1 # number of items to record
rectext = c("Correlation between _g_ and the outbreak peak (Part C).")
recnote = c("Report to the hundredths")
recfuzzy = c(0.01)
allrecord <- filltasks(tid,rc,nrec,rectext,recnote,recfuzzy,allrecord)
rc = rc + nrec

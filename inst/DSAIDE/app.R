             ...
             tabPanel(title = "Menu",
                      ...
                      withTags({
                        div(style = "text-align:left", class="bottomtext",
                            ...
                            tags$div(id = "bottomtext", 'You should start with the apps in the _The Basics_ section and read all its instruction tabs since they contain information relevant for all apps. Most apps are arranged in a way that the best approach is to go through each section, and within a section from left to right. Some apps are out of order. If an app builds specifically on earlier ones, it is usually stated in the _Overview_ section.')
                        )

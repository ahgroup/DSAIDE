...
## Summary
_Dynamical Systems Approaches to Infectious Disease Epidemiology (DSAIDE)_ is an R package that allows you to explore and study concepts of infectious disease epidemiology using dynamical systems models, without the need to read or write computer code.
...
If successfull, you should see a graphical menu open in your browser that looks like this:

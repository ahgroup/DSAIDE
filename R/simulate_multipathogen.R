...
#'   result <- simulate_multipathogen(S10 = 100, S20 = 1e3,  tmax = 100)
...
simulate_multipathogen <- function(S = 1e3, I10 = 1, I20 = 0, I12 = 0, R1 = 0, R2 = 0, R12 = 0, tmax = 120, a = 0, b1 = 0, b2 = 0, b12 = 0, g1 = 1, g2 = 1, g12 = 1)
{
    ############################################################

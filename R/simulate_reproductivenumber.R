...
#' @param f fraction of vaccinated individuals
...
simulate_reproductivenumber <- function(PopSize = 1000, I0 = 0, f = 0.0, tmax = 300, gamma = 50, beta = 1e-1, lambda = 20, n = 1/50, w = 0){

  S0 = PopSize - I0; #initial number of uninfected hosts
  S0eff = (1 - f) * S0;
  Y0 = c(S = S0eff, I = I0, R = 0);  #combine initial conditions into a vector
  ...
  odeoutput = deSolve::ode(y = Y0, times = timevec, func = reproductivenumberode, parms=pars, atol=1e-8, rtol=1e-8);

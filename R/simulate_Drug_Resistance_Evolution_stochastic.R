...
#' @section Code creation date: 2020-10-05
#' @export 
 
simulate_Drug_Resistance_Evolution_stochastic <- function(S = 1000, Iu = 1, It = 1, Ir = 1, R = 0, bu = 0.002, bt = 0.002, br = 0.002, gu = 1, gt = 1, gr = 1, f = 0, cu = 0, ct = 0, tstart = 0, tfinal = 100, dt = 0.1, rngseed = 123) 
{ 
